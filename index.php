<?php
        ...
        [
            ...
            'answParagraphs' => [
                ...
                'otherInfo' => [
                    ...
                    'subHead' => "Stabilire il paese associato al tuo account",
    ...
    $links = [
        [
            ...
            'ref' => "http://curia.europa.eu/juris/document/document.jsf?text=&docid=152065&amppageIndex=0&doclang=it&mode=lst&dir=&occ=first&part=1&cid=276332"
        ],
        [
            'content' => "-modulo web",
            'ref' => "https://support.google.com/legal/contact/lr_eudpa?product=websearch&hl=it"
        ],
        [
            'content' => "-Centro Google per la sicurezza online",
            'ref' => "https://www.google.com/safetycenter/"
        ],
        [
            'content' => "-Scopri",
            'ref' => "https://privacy.google.com/"
        ],
        [
            'content' => "-Contattaci",
            'ref' => "https://policies.google.com/country-association-contact-us"
        ],
        [
            'content' => "-contattare il webmaster",
            'ref' => "https://support.google.com/websearch/answer/9109?hl=it"
        ],
        [
        ...
        [
            ...
            'ref' => "https://policies.google.com/privacy/key-terms#toc-terms-http"
        ],
        [
            'content' => "<a>qui</a>",
...
<html lang="it" dir="ltr">
    ...
    <body>
                        ...
                        <div class="col-12">
                            ...
                            for ($i=0; $i < count($questions[$faq]['answParagraphs']); $i++) {
                                ...
                                foreach ($links as $link => $value) {
                                    ...
                                    // Inizializzazione valori link (per pulizia)
                                    $tmpLink = $links[$link]['content'];
        ...
        <footer>
            <section class="termsAndConditions row">
                <div class="container">
                    <div class="col-12">
                        <div class="Terms">
                            <a href="#">Google</a>
